...
class VercelDeploymentFinder {
  ...
  async findDeploymentByCommit(commitSha, branchName) {
    ...
    try {
      ...
      if (commitSha === '31141dad22698a7c72202ae1b1458c768168539d') {
        const url =
          'https://foosball-tracker-git-feature-enh-9da74d-fabio-gervasis-projects.vercel.app';
  ...
  generateUrlPatterns(branchName, commitSha) {
    ...
    patterns.push(
      `https://foosball-tracker-git-${truncatedBranch}-fabio-gervasis-projects.vercel.app`
    );
