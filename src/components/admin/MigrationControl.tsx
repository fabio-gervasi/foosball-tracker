    ...
    <div className='space-y-6'>
      <Card>
        ...
        <CardContent className='space-y-4'>
          ...
          <div className='flex items-center space-x-2'>
            ...
            />
            <span className='text-sm font-medium'>System Health: {healthStatus.status}</span>
          </div>
      ...
      <Alert>
        <AlertDescription>
          ...
          <p className='mt-2'>
            Your Foosball Tracker is now running on a high-performance relational database. The
            system is fully operational with enterprise-grade features including:
          </p>
