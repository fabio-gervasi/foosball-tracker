...
export function UserManagement({
  ...
  const handleToggleAdminStatus = async (userId: string, currentAdminStatus: boolean) => {
    try {
      ...
      await showSuccess(
        `User admin status ${!currentAdminStatus ? 'granted' : 'revoked'} successfully!`
      );
    } catch (error) {
                          ...
                          <AlertDialogContent>
                            <AlertDialogHeader>
                              ...
                              <AlertDialogDescription>
                                ...
                                <br />
                                <br />
                                The user will be removed from player selection, but their match
                                history and rankings will be preserved.
                              </AlertDialogDescription>
                            </AlertDialogHeader>
                            <AlertDialogFooter>
