...
export function MatchHistory({ currentUser, accessToken, group, users }: MatchHistoryProps) {
  ...
  const formatMatchDisplay = (match: any) => {
    if (match.matchType === '2v2') {
      // Resolve player names from email identifiers
      ...
      // Resolve player names from email identifiers for 1v1
                      ...
                      <div className="p-4">
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="flex items-center justify-between">
                              <div className="flex items-center space-x-3">
                                ...
                                <div className="flex flex-col space-y-0.5">
                                  <span className="text-sm text-gray-800 leading-tight">{team1Player1Name}</span>
                                  <span className="text-sm text-gray-800 leading-tight">{team1Player2Name}</span>
                                </div>
                              </div>
                              ...
                              {match.eloChanges && (
                                <div className="flex flex-col space-y-0.5 items-end">
                                  {(() => {
                                    const eloChange1 = getPlayerEloChange(match, match.team1Player1Email);
                                    return eloChange1 !== null ? (
                                      <span className={`px-1 py-0.5 rounded text-xs leading-tight ${
                                  ...
                                  {(() => {
                                    const eloChange2 = getPlayerEloChange(match, match.team1Player2Email);
                          ...
                          <div className="flex items-center justify-center py-1">
                            <span className="text-xs text-gray-500 font-medium bg-gray-100 px-3 py-1 rounded-full">VS</span>
                          </div>
                          ...
                          <div className={`rounded-lg border-2 p-3 ${
                            ...
                            <div className="flex items-center justify-between">
                              <div className="flex items-center space-x-3">
                                ...
                                {/* Names stacked vertically */}
                                <div className="flex flex-col space-y-0.5">
                                  <span className="text-sm text-gray-800 leading-tight">{team2Player1Name}</span>
                                  <span className="text-sm text-gray-800 leading-tight">{team2Player2Name}</span>
                                </div>
                              </div>
                              {/* ELO changes stacked vertically */}
                              {match.eloChanges && (
                                <div className="flex flex-col space-y-0.5 items-end">
                                  {(() => {
                                    const eloChange1 = getPlayerEloChange(match, match.team2Player1Email);
                                    return eloChange1 !== null ? (
                                      <span className={`px-1 py-0.5 rounded text-xs leading-tight ${
                                        eloChange1 > 0 ? 'text-green-600' : 'text-red-600'
                                      }`}>
                                  ...
                                  {(() => {
                                    const eloChange2 = getPlayerEloChange(match, match.team2Player2Email);
                                    return eloChange2 !== null ? (
                                      <span className={`px-1 py-0.5 rounded text-xs leading-tight ${
                                        eloChange2 > 0 ? 'text-green-600' : 'text-red-600'
                                      }`}>
                          ...
                          <div className="flex items-center space-x-4 flex-1">
                            ...
                            <div className="flex items-center space-x-2 flex-1">
                              ...
                              <div className="min-w-0 flex-1">
                                <span className="text-sm text-gray-800 truncate block">{player1Name}</span>
                                {match.eloChanges && (
                                  <div className="text-xs">
                                    {(() => {
                                      const eloChange = getPlayerEloChange(match, match.player1Email);
                                      if (eloChange !== null) {
                                        return (
                                          <span className={`${
                            ...
                            <div className="flex items-center space-x-2 flex-1">
                              ...
                              <div className="min-w-0 flex-1">
                                <span className="text-sm text-gray-800 truncate block">{player2Name}</span>
                                {match.eloChanges && (
                                  <div className="text-xs">
                                    {(() => {
                                      const eloChange = getPlayerEloChange(match, match.player2Email);
                                      if (eloChange !== null) {
                                        return (
                                          <span className={`${
                                            eloChange > 0 ? 'text-green-600' : 'text-red-600'
