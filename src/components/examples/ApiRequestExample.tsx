        ...
        <CardContent className="space-y-4">
              ...
              <Card>
                ...
                <CardContent>
                  <Button 
                    ...
                    className="w-full"
                  >
                    {createUserRequest.isLoading && <Loader2 className="mr-2 h-4 w-4 animate-spin" />}
                    Create User
                  </Button>
          ...
          <div className="border-t pt-4">
            ...
            <div className="text-sm space-y-2 text-gray-600">
              ...
              <p className="pt-2"><strong>Configuration Options:</strong></p>
              <ul className="list-disc list-inside space-y-1 ml-4">
                <li><code>retries</code>: Number of retry attempts (default: 3)</li>
                <li><code>timeout</code>: Request timeout in ms (default: 30000)</li>
                <li><code>skipAuth</code>: Skip automatic auth headers (default: false)</li>
                <li><code>enableCache</code>: Enable React Query caching (default: false)</li>
                <li><code>optimistic</code>: Enable optimistic updates (default: false)</li>
              </ul>
            </div>
          </div>
        </CardContent>
