...
const AppContent: React.FC = () => {
  ...
  useEffect(() => {
    const checkRoute = () => {
      ...
      const token =
        searchParams.get('token') || hashParams.get('token') || searchParams.get('token_hash');
  ...
  if (isLoading) {
    return <LoadingScreen message='Checking authentication...' showLogo={true} variant='full' />;
  }
